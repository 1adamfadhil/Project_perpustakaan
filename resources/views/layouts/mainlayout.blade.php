...
<body>
    ...
    <div class="main d-flex flex-column justify-content-between">
        <nav class="navbar navbar-dark navbar-expand-lg bg-primary">
          ...
          <div class="body-content h-100" id="navbarTogglerDemo03">
                ...
                <div class="sidebar col-lg-2 collapse d-lg-block">
                    @if (Auth::user())
                        ...
                        <a href="/books" @if(request()->route()->uri == 'books' || request()->route()->uri == 'book-add' || 
                            ...
                            || request()->route()->uri == 'book-delete/{slug}') class='active'
                            @endif>Books</a>
                        <a href="/categories" @if(request()->route()->uri == 'categories'|| request()->route()->uri == 'category-add' || 
                            ...
                            @endif>Categories</a>
                        <a href="/users" @if(request()->route()->uri == 'users' || request()->route()->uri == 'registed-users' || 
